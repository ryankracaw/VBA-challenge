...
For Each ws In Worksheets
    ...
    ws.Cells(3, 17).Value = WorksheetFunction.Min(arr()) * 100
    ws.Cells(4, 17).Value = WorksheetFunction.Max(arry())
    
    'Putting Ticker values into cells
    ws.Cells(2, 16).Value = WorksheetFunction.Index(Range("I2:I3001"), WorksheetFunction.Match(Cells(2, 17).Value, Range("K2:K3001"))) 'Greatest increase
    ws.Cells(3, 16).Value = WorksheetFunction.Index(Range("I2:I3001"), WorksheetFunction.Match(Cells(3, 17).Value, Range("K2:K3001"))) 'Greatest decrease
    ws.Cells(4, 16).Value = WorksheetFunction.Index(Range("I2:I3001"), WorksheetFunction.Match(Cells(4, 17).Value, Range("L2:L3001"))) 'Greatest volume
